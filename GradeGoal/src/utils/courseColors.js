...
// ========================================
// This utility provides color schemes for courses to ensure visual consistency
// and easy identification. It includes predefined color palettes with gradients
// and variants for different UI elements.
...
export const getCourseColorScheme = (courseName, customColorIndex = null) => {
  ...
  if (
    ...
    customColorIndex >= 0 &&
    customColorIndex < colors.length
  ) {
