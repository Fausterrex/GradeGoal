...
// ========================================
// This is the main landing page that showcases the GradeGoal application features.
// It includes hero section with interactive cards, feature highlights,
// and call-to-action buttons for user registration and login.
      ...
      <div className="page flex flex-col items-center w-full bg-gray-50 overflow-y-auto ">
        ...
        <div className="flex flex-col md:flex-row items-center gap-0 mt-25">
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`${card.cardHeaderBG} w-full text-center py-3 rounded-t-4xl `}
                >
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="my-4 max-w-lg text-center text-gray-600 text-[20px]">
            GradeGoal is a web-based Decision Support System that empowers
            students to achieve their academic goals through strategic planning,
            progress tracking, and intelligent guidance.
          </p>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 max-w-md my-10 mx-3 text-[18px]">
                    Everything you need to track, analyze and improve your
                    academic performance in one comprehensive platform.
                  </p>
                </div>
              </div>
                ...
                >
                  <div className="rounded-2xl shadow-md bg-white p-4 sm:p-6 text-center flex flex-col items-center justify-center h-[320px] sm:h-[360px]">
                    ...
                    <div className="mb-4 sm:mb-6">
                      <div
                        className={`w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br ${f.iconBg} rounded-2xl flex items-center justify-center shadow-lg mx-auto`}
                      >
                        <img
                          src={f.icon}
                          alt="feature icon"
                    ...
                    {/* ========================================
                        FEATURE TITLE
                        ======================================== */}
                    <h3 className="font-semibold text-base sm:text-lg lg:text-xl text-black px-2 mb-2 sm:mb-3">
                      {f.title}
                    </h3>
                    {/* ========================================
                        FEATURE DESCRIPTION
            ...
            <div className="md:col-span-2 lg:col-span-1 flex flex-col items-center justify-center">
              <div className="w-full max-w-sm sm:max-w-md rounded-3xl p-4 sm:p-6 bg-[#D8CFE5] shadow-lg hover:scale-105 transition duration-300">
                <div className="rounded-2xl shadow-md bg-white p-4 sm:p-6 text-center flex flex-col items-center justify-center h-[320px] sm:h-[360px]">
                  ...
                  <div className="mb-4 sm:mb-6">
                    <div
                      className={`w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-[#58CF41] to-[#439C31] rounded-2xl flex items-center justify-center shadow-lg mx-auto`}
                    >
                      <img
                        src={goalIcon}
                        alt="feature icon"
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm leading-relaxed px-2 mb-4 sm:mb-6 flex-1">
                    Define target grades or GPA for each course. System
                    continuously evaluates progress to meet your academic goals.
                  </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-100 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              GradeGoal is a web-based Decision Support System that empowers
              students to achieve their academic goals through strategic
              planning, progress tracking, and intelligent guidance.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-[#8168C5] mt-12 pt-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-gray-200 text-sm">
              © 2024 Grade Goal. All rights reserved. | Designed with ❤️ for
              students
            </p>
          </div>
        </div>
