...
// ========================================
// This component displays detailed grade information for a specific course
// Features: Grade display, target grades, course details, grade calculations
...
function GradeEntry({ course, onGradeUpdate, onBack }) {
  ...
  const loadUserAndTargetGrade = async () => {
    try {
      ...
      // Fetch academic goals for this course
      const goals = await getAcademicGoalsByCourse(
        userProfile.userId,
        course.courseId
      );

      // Find the first COURSE_GRADE goal for this course
  ...
  const getCategoryAverage = (categoryId) => {
    ...
    try {
      ...
      // Return null if average is 0 (no valid grades) to show "--" instead of "1.00"
  ...
  const getTargetGradeDisplay = () => {
    // Display target grade from academic goals if available
    if (targetGrade !== null) {
    ...
    >
      ...
      <div
        className={`bg-gradient-to-br ${
          ...
          course.isActive === false ? "border-l-4 border-yellow-400" : ""
        } flex-shrink-0`}
      >
        <div className="w-full px-8 py-8">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <button
              ...
              className={`flex items-center gap-3 ${
                ...
                course.isActive === false ? "hover:bg-gray-400" : ""
              }`}
            ...
            >
              ...
              <span className="font-medium">
                {course.isActive === false ? "View" : "Edit"}
              </span>
            </button>
          </div>
          ...
          <div
            className={`max-w-5xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-6 ${
              course.isActive === false ? "opacity-75" : ""
            }`}
          >
            {/* ========================================
                CURRENT GPA CARD
                          ...
                          categoryGrades.map((grade) => {
                            ...
                            return (
                              <div
                                ...
                                onClick={() =>
                                  !hasScore && handleAssessmentClick(grade)
                                }
                              >
                                {/* ========================================
                                  ...
                                  <button
                                    onClick={(e) => {
                                      ...
                                      setNewGrade({
                                        ...
                                        note: grade.note || "",
                                        isExtraCredit:
                                          grade.isExtraCredit || false,
                                        extraCreditPoints:
                                          grade.extraCreditPoints || null,
                                      });
                                      setShowAddGrade(true);
                                    }}
