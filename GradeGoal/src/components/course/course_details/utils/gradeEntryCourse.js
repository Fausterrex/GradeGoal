...
// Progress calculation functions moved to centralized service
// See: GradeGoal/src/services/progressCalculationService.js

/**
 * Calculate course progress based on completed assessments for a specific semester term
 * Progress considers both existing assessments and expected assessments per category
 */
export const calculateCourseProgressByTerm = (categories, grades, activeSemesterTerm) => {
  ...
  categories.forEach((category) => {
    ...
    // Count completed assessments in this category for the specific term
...
// calculateCourseProgress function moved to centralized service
// See: GradeGoal/src/services/progressCalculationService.js
...
/**
 * Get course statistics for a specific semester term
 */
export const getCourseStatisticsByTerm = (categories, grades, activeSemesterTerm) => {
