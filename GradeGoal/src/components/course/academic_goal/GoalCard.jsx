        ...
        {!progressData.isCourseCompleted && !isCompact && (
          <div className="flex items-center space-x-2 text-sm mb-4">
            ...
            <div className="flex-1 bg-gray-200 rounded-full h-1.5">
              <div
                className={`h-1.5 rounded-full transition-all duration-300 ${progressData.achievementProbability >= 70
                  ? "bg-green-500"
            ...
            <span
              className={`font-semibold ${progressData.achievementProbability >= 70
                ? "text-green-600"
                : progressData.achievementProbability >= 40
                  ? "text-yellow-600"
                  : "text-red-600"
